/*
  ...
  gengetopt.exe -G -i E:\SOURCESAFE\AsyncStream\AsyncStream\AsyncStream.ggo -F cmdline 
...
const char *gengetopt_args_info_purpose = "AsyncStream is used for demo something";

const char *gengetopt_args_info_usage = "Usage: use --help";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -u, --url=STRING  downloading url  (default=`http://www.baidu.com')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->url_arg = gengetopt_strdup ("http://www.baidu.com");
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvu:", long_options, &option_index);
